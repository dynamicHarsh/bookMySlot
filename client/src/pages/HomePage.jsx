...
const HomePage = () => {
  return (
    <>
      <Nav/>
      <Space direction="vertical" style={{position:"relative",top:"4rem",width: "100%",}} size={[0, 48]} className="space">
        ...
        <Content style={contentStyle} className="headerStyle">
          <Row>
            <Col flex="1" className="contentt tagline">
             ...
             <Typography className="tagline firstLine">
                ...
                <span style={{color:"#710193"}}>
                  <TypeAnimation  sequence={['Health',5000, 'Time',5000,]}
                                  wrapper="span"
                                  speed={50}
              ...
              <Typography className="tagline secondLine">
                ...
                <span style={{color:"#710193"}}>
                  <TypeAnimation  sequence={['Ease',1500, 'Convenience',1500,'Choice',1500,]}
                                  wrapper="span"
                                  speed={50}
                                  style={{ display: 'inline-block' }}
                                  repeat={Infinity}
              ...
              >
                <Link to="/login" style={{ textDecoration: "none",fontSize:"xx-large"}}>
            ...
            <Col flex="1" className="contentt image">
              <img src={doctor} style={{width: 632.25, height: 450, filter: 100,padding:10 }} className="doctorImage" />
            </Col>
        ...
        <div className="info">
          ...
          <div className="departments">
            ...
            <Card className='card' hoverable cover={<img className="cardImage" alt="neurology" src={neurology}/>} >
            ...
            <Card className='card' hoverable cover={<img className="cardImage" alt="generalphysician" src={generalphysician} />}>
            ...
            <Card className='card' hoverable cover={<img className="cardImage" alt="generalphysician" src={orthopaedics} />}>
            ...
            <Card className='card' hoverable cover={<img className="cardImage" alt="cardiology" src={cardiology} />}>
            ...
            <Card className='card' hoverable cover={<img className="cardImage" alt="gynecologist" src={gynecologist} />}>
